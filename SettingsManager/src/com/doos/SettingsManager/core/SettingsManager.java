package com.doos.SettingsManager.core;
...
import com.doos.SettingsManager.registry.RegistryCanNotWriteInfoException;
import com.doos.SettingsManager.registry.RegistryException;
import com.doos.SettingsManager.registry.RegistryManager;
import com.doos.SettingsManager.registry.fixer.RegistryFixerAppVersionKeyFailException;
import com.doos.SettingsManager.registry.fixer.RegistryFixerAutoUpdateKeyFailException;
...
public class SettingsManager {
    ...
    public static Properties loadInfo() throws RegistryCanNotReadInfoException, RegistryCanNotWriteInfoException {
        ...
        //Fixes com.doos.com.doos.SettingsManager.core.SettingsManager.registry after update (if needed)
    ...
    public static Properties fixRegistry()
        ...
        System.out.println(
                "[REGISTRY FIXER] Trying to check and fix com.doos.com.doos.SettingsManager.core.SettingsManager.registry values.");
        Properties result = new Properties();
        try {
            result.setProperty(RegistryManager.KEY_AUTO_UPDATE, Boolean.toString(RegistryManager.isAutoUpdateActive()));
