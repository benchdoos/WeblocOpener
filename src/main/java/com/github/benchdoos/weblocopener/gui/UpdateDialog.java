...
public class UpdateDialog extends JFrame implements Translatable {
  ...
  private void $$$setupUI$$$() {
    ...
    this.$$$loadButtonText$$$(
        buttonOK, this.$$$getMessageFromBundle$$$("translations/UpdateDialogBundle", "buttonOk"));
    panel2.add(
        buttonOK,
        new GridConstraints(
            1,
    ...
    this.$$$loadButtonText$$$(
        ...
        this.$$$getMessageFromBundle$$$(
            "translations/UpdateDialogBundle", "manualDownloadButtonText"));
    manualDownloadButton.setToolTipText(
        this.$$$getMessageFromBundle$$$(
            "translations/UpdateDialogBundle", "manualDownloadButtonToolTip"));
    panel2.add(
        manualDownloadButton,
        new GridConstraints(
            1,
    ...
    this.$$$loadLabelText$$$(
        ...
        this.$$$getMessageFromBundle$$$(
            "translations/UpdateDialogBundle", "currentVersionStringLabel"));
    panel4.add(
        currentVersionStringLabel,
        new GridConstraints(
            0,
    ...
    this.$$$loadLabelText$$$(
        ...
        this.$$$getMessageFromBundle$$$(
            "translations/UpdateDialogBundle", "availableVersionStringLabel"));
    panel4.add(
        availableVersionStringLabel,
        new GridConstraints(
            1,
    ...
    Font currentVersionLabelFont =
        this.$$$getFont$$$(null, Font.BOLD, -1, currentVersionLabel.getFont());
    ...
    Font availableVersionLabelFont =
        this.$$$getFont$$$(null, Font.BOLD, -1, availableVersionLabel.getFont());
        ...
        new ActionListener() {
          ...
          private void openSetupUrl() {
            ...
            if (updater != null) {
              ...
              if (serverAppVersion != null) {
                try {
                  final AppVersion.Asset installerAsset =
                      updater.getInstallerAsset(serverAppVersion);
                  ...
                  log.warn(
                      "Could not get asset url, opening github page: {}",
